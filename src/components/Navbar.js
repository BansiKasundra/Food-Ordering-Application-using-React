...
<nav className="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: '#CCAD80' }}>
  <div className="container-fluid">
    <Link className="navbar-brand fs-1" to="/">BiteBliss</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav me-auto">
        ...
        {(localStorage.getItem("authToken"))?
          <li className="nav-item">
            {/* <Link className="nav-link active fs-4" style={{ fontWeight: 'bold' }} aria-current="page" to="/">My Orders</Link> */}
      ...
      <div>
        ...
        <div className='btn bg-white text-dark mx-2' onClick={handleLogout}>Logout</div>
      </div>
      }
